...
async function result() {
    ...
    if (name.trim() === "") {
        ...
        if (updateMyLanguage() === "Eng") {
            ...
            document.getElementById('result').textContent =  "你需要填写你的名字，我的朋友。我们不会记录你的名字，这个是给你自己的.";
        }
    } else {
        var outcome = "";
        var sentence = "";
        ...
        if (updateMyLanguage() === "Eng") {
            ...
            document.getElementById('result').textContent = "你的霍普金斯生活被鉴定为" + outcome_ch + ". " + sentence_ch;
