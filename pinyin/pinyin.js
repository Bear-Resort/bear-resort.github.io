! function(n, i) {
    "object" == typeof exports && "undefined" != typeof module ? i(exports) : "function" == typeof define && define.amd ? define(["exports"], i) : i((n = "undefined" != typeof globalThis ? globalThis : n || self).pinyinPro = {})
}(this, (function(n) {
    "use strict";
    const i = /^[\uD800-\uDBFF]$/,
        g = /^[\uDC00-\uDFFF]$/,
    ...
    function o(n) {
        var i;
        return n.length - ((null === (i = n.match(h)) || void 0 === i ? void 0 : i.length) || 0)
    }
    ...
    function z(n) {
        ...
        for (; u < n.length;) {
            const s = n[u];
            i.test(s) && g.test(n[u + 1]) ? (h.push(n.substring(u, u + 2)), u += 2) : (h.push(s), u += 1)
        }
        return h
    }
    class t {
        constructor() {
            this.NumberDICT = [], this.StringDICT = new Map
        }
        get(n) {
            if (n.length > 1) return this.StringDICT.get(n);
            {
                const i = n.charCodeAt(0);
                return this.NumberDICT[i]
            }
        }
        set(n, i) {
            if (n.length > 1) this.StringDICT.set(n, i);
            else {
    ...
    Object.keys(y).forEach((n => {
        const i = y[n];
        for (let g of i) l.set(g, n)
    }));
    const c = ["zh", "ch", "sh", "z", "c", "s", "b", "p", "m", "f", "d", "t", "n", "l", "g", "k", "h", "j", "q", "x", "r", "y", "w", ""],
        j = ["j", "q", "x"],
        d = ["uān", "uán", "uǎn", "uàn", "uan", "uē", "ué", "uě", "uè", "ue", "ūn", "ún", "ǔn", "ùn", "un", "ū", "ú", "ǔ", "ù", "u"],
        e = {
            "uān": "üān",
            "uán": "üán",
            "uǎn": "üǎn",
        ...
        r = ["ia", "ian", "iang", "iao", "ie", "iu", "iong", "ua", "uai", "uan", "uang", "ue", "ui", "uo", "üan", "üe", "van", "ve"],
        b = {
            "一": "yì",
            "二": "èr",
            "三": "sān",
    ...
    function a(n, i, g) {
        return function(n, i) {
            if ("々" === n) return i && l.get(i) ? l.get(i).split(" ")[0] : "tóng"
        }(n, i) || function(n, i) {
            if (!("了" !== n || i && l.get(i))) return "liǎo"
        }(n, i) || function(n, i, g) {
            if (-1 === q.indexOf(n)) return J(n);
            if (i === g && i && J(i) !== i) return V(J(n));
            if (g && !f[n].includes(g)) {
                const i = J(g);
                if (i !== g) {
                    const g = gn(i),
                        h = w[n];
                    for (let n in h)
                        if (-1 !== h[n].indexOf(Number(g))) return n
                }
            }
        }(n, i, g) || J(n)
    }
    ...
    function E(n) {
        return n.priority === s.Custom ? -n.length * n.length * 100 : n.priority === s.Surname ? -n.length * n.length * 10 : 0
    }
    ...
    function M(n) {
        return n.priority === s.Custom ? -n.length * n.length * 1e5 : n.priority === s.Surname ? -n.length * n.length * 100 : 1
    }
    var I;
    ! function(n) {
    ...
    class R {
        constructor(n, i = "", g = "") {
            this.children = new Map, this.fail = null, this.patterns = [], this.parent = n, this.prefix = i, this.key = g
        }
    }
    const B = [...F, ...T, ...P, ...Z, ...p, ...v],
        W = new class {
            constructor() {
                this.dictMap = new Map, this.queues = [], this.root = new R(null)
            }
            build(n) {
                this.buildTrie(n), this.buildFailPointer()
            }
            buildTrie(n) {
                for (let i of n) {
                    const n = z(i.zh);
                    ...
                    for (let i = 0; i < n.length; i++) {
                        let h = n[i];
                        if (!g.children.has(h)) {
                            const u = new R(g, n.slice(0, i).join(""), h);
                            g.children.set(h, u), this.addNodeToQueues(u)
                        }
                        g = g.children.get(h)
                    }
                    this.insertPattern(g.patterns, i), i.node = g, this.addPatternToDictMap(i)
                }
            }
            buildFailPointer() {
                let n = [],
                ...
                for (this.queues.forEach((i => {
                        n = n.concat(i)
                    })), this.queues = []; n.length > i;) {
                    let g = n[i++],
                        h = g.parent && g.parent.fail,
                        u = g.key;
                    for (; h && !h.children.has(u);) h = h.fail;
                    g.fail = h ? h.children.get(u) : this.root
                }
            }
            addPatternToDictMap(n) {
                this.dictMap.has(n.dict) || this.dictMap.set(n.dict, new Set), this.dictMap.get(n.dict).add(n)
            }
            addNodeToQueues(n) {
                this.queues[o(n.prefix)] || (this.queues[o(n.prefix)] = []), this.queues[o(n.prefix)].push(n)
            }
            insertPattern(n, i) {
                for (let g = n.length - 1; g >= 0; g--) {
                    const h = n[g];
                    if (i.priority === h.priority && i.probability >= h.probability) n[g + 1] = h;
                    else {
                        if (!(i.priority > h.priority)) return void(n[g + 1] = i);
                        n[g + 1] = h
                    }
                }
                n[0] = i
            ...
            removeDict(n) {
                if (this.dictMap.has(n)) {
                    this.dictMap.get(n).forEach((n => {
                        n.node.patterns = n.node.patterns.filter((i => i !== n))
                    })), this.dictMap.delete(n)
                }
            }
            match(n, i) {
                let g = this.root,
                ...
                for (let n = 0; n < u.length; n++) {
                    let o = u[n];
                    for (; null !== g && !g.children.has(o);) g = g.fail;
                    if (null === g) g = this.root;
                    else {
                        g = g.children.get(o);
                        const u = g.patterns.find((g => "off" === i ? g.priority !== s.Surname : "head" !== i || g.length - 1 - n == 0));
                        u && h.push(Object.assign(Object.assign({}, u), {
                            index: n - u.length + 1
                        }));
                        let z = g.fail;
                        for (; null !== z;) {
                            const g = z.patterns.find((g => "off" === i ? g.priority !== s.Surname : "head" !== i || g.length - 1 - n == 0));
                            g && h.push(Object.assign(Object.assign({}, g), {
                                index: n - g.length + 1
                            })), z = z.fail
                        }
                    }
            ...
            search(n, i, g = 2) {
                const h = this.match(n, i);
                return 1 === g ? function(n) {
                    const i = [];
                    for (let u = n.length - 1; u >= 0;) {
                        const {
                            index: s
                        } = n[u];
                        let o = u - 1;
                        for (; o >= 0 && (g = n[u], !((h = n[o]).index + h.length <= g.index || h.priority > g.priority || h.priority === g.priority && h.length > g.length));) o--;
                        (o < 0 || n[o].index + n[o].length <= s) && i.push(n[u]), u = o
                    }
                    var g, h;
                    return i.reverse()
                }(h) : 3 === g ? function(n, i) {
                    ...
                    for (let s = i - 1; s >= 0; s--) {
                        ...
                        g[s] = N(g[s], z), g[s].concatPattern && (g[s].patterns = g[s].patterns.concat(g[s].concatPattern), g[s].concatPattern = void 0, delete g[s + 1])
                    }
                    ...
                    for (let s = i - 1; s >= 0; s--) {
                        ...
                        for (; u && u.index + u.length - 1 === s;) {
                            const i = u.index,
                                s = {
                                    probability: u.probability * o.probability,
                                    decimal: o.decimal + E(u),
                                    patterns: o.patterns,
                                    concatPattern: u
                                };
                            D(s), g[i] = $(g[i], s), u = n[--h]
                        ...
                        const z = {
                            probability: 1e-13 * o.probability,
                            decimal: 0,
                            patterns: o.patterns
                        };
                        D(z), g[s] = $(g[s], z), g[s].concatPattern && (g[s].patterns = g[s].patterns.concat(g[s].concatPattern), g[s].concatPattern = void 0, delete g[s + 1])
                    }
                    return g[0].patterns.reverse()
                }(h, o(n))
            }
    ...
    function _(n, i, g) {
        for (let h in n) {
            ...
            z(h).forEach(((n, h) => {
                const s = u.split(" ")[h] || "";
                "replace" === g || "add" === g && !i.get(n) && !l.get(n) ? i.set(n, s) : (i.set(n, i.get(n) || l.get(n)), i.get(n).split(" ").includes(s) || i.set(n, `${i.get(n)} ${s}`.trim()))
            }))
        }
    }
    const G = () => Q;
    const J = n => {
        ...
        K = (n, i, g, h) => {
            const u = W.search(n, g, h);
            let o = 0;
            const t = z(n);
            for (let n = 0; n < t.length;) {
                const g = u[o];
                if (g && n === g.index) {
                    if (1 === g.length && g.priority <= s.Normal) {
                        const g = t[n];
                        let h = "";
                        h = a(g, t[n - 1], t[n + 1]), i[n] = {
                            origin: g,
                            result: h,
                            isZh: h !== g,
                            originPinyin: h
        ...
        V = n => n.replace(/(ā|á|ǎ|à)/g, "a").replace(/(ō|ó|ǒ|ò)/g, "o").replace(/(ē|é|ě|è)/g, "e").replace(/(ī|í|ǐ|ì)/g, "i").replace(/(ū|ú|ǔ|ù)/g, "u").replace(/(ǖ|ǘ|ǚ|ǜ)/g, "ü").replace(/(n̄|ń|ň|ǹ)/g, "n").replace(/(m̄|ḿ|m̌|m̀)/g, "m").replace(/(ê̄|ế|ê̌|ề)/g, "ê"),
        X = (n, i = "off") => {
            const g = L;
            let h = l.get(n) ? l.get(n).split(" ") : [];
            if (g.get(n)) h = g.get(n).split(" ");
            else if ("off" !== i) {
                const i = k[n];
                i && (h = [i].concat(h.filter((n => n !== i))))
            }
            return h
        },
        Y = n => {
            ...
            for (let n of i)
                for (let i of c)
                    if (n.startsWith(i)) {
                        let u = n.slice(i.length); - 1 !== j.indexOf(i) && -1 !== d.indexOf(u) && (u = e[u]), g.push(i), h.push(u);
                        break
                    } return {
                final: h.join(" "),
                initial: g.join(" ")
        ...
        nn = n => {
            ...
            let g = "",
                h = "",
                u = "";
            return -1 !== r.indexOf(V(i)) ? (g = i[0], h = i[1], u = i.slice(2)) : (h = i[0] || "", u = i.slice(1) || ""), {
                head: g,
                body: h,
                tail: u
            }
        ...
        gn = n => {
            const i = /(ā|ō|ē|ī|ū|ǖ|n̄|m̄|ê̄)/,
                g = /(á|ó|é|í|ú|ǘ|ń|ḿ|ế)/,
                h = /(ǎ|ǒ|ě|ǐ|ǔ|ǚ|ň|m̌|ê̌)/,
                u = /(à|ò|è|ì|ù|ǜ|ǹ|m̀|ề)/,
                s = /(a|o|e|i|u|ü|ê)/,
                o = /(n|m)$/,
                z = [];
            return n.split(" ").forEach((n => {
                i.test(n) ? z.push("1") : g.test(n) ? z.push("2") : h.test(n) ? z.push("3") : u.test(n) ? z.push("4") : s.test(n) || o.test(n) ? z.push("0") : z.push("")
            })), z.join(" ")
        },
        hn = (n, i) => {
            const g = [];
        ...
        un = n => "string" == typeof n || (console.error("The first param of pinyin is error: " + n + ' is not assignable to type "string".'), !1);

    function sn(n, i) {
        return !(i instanceof RegExp) || i.test(n)
    }
    const on = (n, i) => {
            let g = i.nonZh;
            if ("removed" === g) return n.filter((n => n.isZh || !sn(n.origin, i.nonZhScope)));
            if ("consecutive" === g) {
                for (let g = n.length - 2; g >= 0; g--) {
                    const h = n[g],
                        u = n[g + 1];
                    !h.isZh && !u.isZh && sn(h.origin, i.nonZhScope) && sn(u.origin, i.nonZhScope) && (h.origin += u.origin, h.result += u.result, u.delete = !0)
                }
                return n.filter((n => !n.delete))
            }
            return n
        },
        zn = (n, i) => !(1 !== o(n) || !i.multiple) && ((n, i = "off") => {
            let g = X(n, i);
            return g.length > 0 ? g.map((i => ({
                origin: n,
                result: i,
                isZh: !0,
                originPinyin: i
        ...
        tn = (n, i) => {
            switch (i.pattern) {
                ...
                case "num":
                    n.forEach((n => {
                        n.result = n.isZh ? gn(n.result) : ""
                    }));
                    break;
                case "initial":
                    n.forEach((n => {
                        n.result = n.isZh ? Y(n.result).initial : ""
                    }));
                    break;
                case "final":
                    n.forEach((n => {
                        n.result = n.isZh ? Y(n.result).final : ""
                    }));
                    break;
                case "first":
                    n.forEach((n => {
                        n.result = hn(n.result, n.isZh)
                    }));
                    break;
                case "finalHead":
                    n.forEach((n => {
                        n.result = n.isZh ? nn(n.result).head : ""
                    }));
                    break;
                case "finalBody":
                    n.forEach((n => {
                        n.result = n.isZh ? nn(n.result).body : ""
                    }));
                    break;
                case "finalTail":
                    n.forEach((n => {
                        n.result = n.isZh ? nn(n.result).tail : ""
                    }))
            }
        },
        yn = (n, i) => {
        ...
        ln = (n, i) => {
            i.v && n.forEach((n => {
                n.isZh && (n.result = n.result.replace(/ü/g, "v"))
            }))
        },
        cn = (n, i) => (!1 === i && n.forEach((n => {
            "一" === n.origin ? n.result = n.originPinyin = "yī" : "不" === n.origin && (n.result = n.originPinyin = "bù")
        })), n),
        jn = {
            pattern: "pinyin",
            toneType: "symbol",
    ...
    function dn(n, i) {
        i = Object.assign(Object.assign({}, jn), i || {});
        if (!un(n)) return n;
        if ("" === n) return "array" === i.type || "all" === i.type ? [] : "";
        void 0 === i.surname && ("surname" === i.mode ? i.surname = "all" : i.surname = "off"), "all" === i.type && (i.pattern = "pinyin"), "num" === i.pattern && (i.toneType = "none"), i.removeNonZh && (i.nonZh = "removed");
        let g = Array(o(n)),
            {
                list: h
            } = K(n, g, i.surname, i.segmentit);
        return h = cn(h, i.toneSandhi), h = on(h, i), zn(n, i) && (h = zn(n, i)), tn(h, i), yn(h, i), ln(h, i), ((n, i, g) => {
            if (i.multiple && 1 === o(g)) {
                let i = "";
                n = n.filter((n => {
                    const g = n.result !== i;
            ...
            return "array" === i.type ? n.map((n => n.result)) : "all" === i.type ? n.map((n => {
                const g = n.isZh ? n.result : "",
                    {
                        initial: h,
                        final: u
                    } = Y(g),
                ...
                let t = [];
                return "" !== g && (t = [g].concat(X(n.origin, i.surname).filter((n => n !== g)))), {
                    origin: n.origin,
                    pinyin: g,
                    initial: h,
                    final: u,
                    first: hn(n.result, n.isZh),
                    finalHead: s,
                    finalBody: o,
                    finalTail: z,
                    num: Number(gn(n.originPinyin)),
                    isZh: n.isZh,
                    polyphonic: t,
                    inZhRange: !!l.get(n.origin),
                    result: n.result
                }
            })) : n.map((n => n.result)).join(i.separator)
        })(h, i, n)
    }
    const en = Symbol("default"),
        rn = new Map;

    function bn(n, i, g, h = "add") {
        rn.get(n) || rn.set(n, {});
        const u = rn.get(n);
        if (u[i] || (u[i] = l.get(i)), "add" === h) {
            const n = l.get(i);
            n && !n.split(" ").includes(g) ? l.set(i, `${n} ${g}`) : l.get(i) || l.set(i, g)
        } else "replace" === h && l.set(i, g)
    }
    const xn = {
            precision: "first",
            continuous: !1,
        ...
        mn = (n, i) => {
            let g = 0;
            for (let h = 0; h < n.length; h++) n[h] === i[g] && g++;
            return g
        },
        pn = (n, i, g) => {
            let h = [];
            ...
            for (let n = 0; n < u.length; n++) {
                ...
                if (o.forEach((n => {
                        const g = mn(n, i);
                        g > z && (z = g)
                    })), z && (i = i.slice(z), h.push(n)), !i) break
            }
            if (i) return null;
            if (g.continuous) {
                const n = h;
                if (h.some(((i, g) => g > 0 && i !== n[g - 1] + 1))) return null
            }
            return "ignore" === g.space && (h = h.filter((n => " " !== u[n]))), h.length ? h : null
        },
        wn = (n, i, g) => {
            const h = z(n),
                u = Array(h.length + 1);
            for (let n = 0; n < u.length; n++) u[n] = Array(i.length + 1), u[n][0] = [];
            for (let n = 0; n < u[0].length; n++) u[0][n] = [];
            for (let n = 1; n < u.length; n++) {
                if (!g.continuous || "ignore" == g.space && " " === h[n - 1])
                    for (let g = 1; g <= i.length; g++) u[n][g - 1] = u[n - 1][g - 1];
                for (let s = 1; s <= i.length; s++)
                    if (u[n - 1][s - 1] && (1 === s || u[n - 1][s - 1].length)) {
                        const o = dn(h[n - 1], {
                            type: "array",
                            toneType: "none",
                            multiple: !0,
                        ...
                        if (h[n - 1] === i[s - 1]) {
                            const g = [...u[n - 1][s - 1], n - 1];
                            if ((!u[n][s] || g.length > u[n][s].length) && (u[n][s] = g), s === i.length) return u[n][s]
                        }
                        if (i.length - s <= 6) {
                            if (o.some((n => "any" === g.lastPrecision ? n.includes(i.slice(s - 1, i.length)) : "start" === g.lastPrecision ? n.startsWith(i.slice(s - 1, i.length)) : "first" === g.lastPrecision ? n[0] === i.slice(s - 1, i.length) : "every" === g.lastPrecision && n === i.slice(s - 1, i.length)))) return [...u[n - 1][s - 1], n - 1]
                        }
                        const z = g.precision;
                        if ("start" === z && o.forEach((g => {
                                let h = s;
                                const o = [...u[n - 1][s - 1], n - 1];
                                for (; h <= i.length && g.startsWith(i.slice(s - 1, h));)(!u[n][h] || o.length > u[n][h].length) && (u[n][h] = o), h++
                            })), "first" === z && o.some((n => n[0] === i[s - 1]))) {
                            const i = [...u[n - 1][s - 1], n - 1];
                            (!u[n][s] || i.length > u[n][s].length) && (u[n][s] = i)
                        }
                        const t = o.find((n => n === i.slice(s - 1, s - 1 + n.length)));
                        if (t) {
                            const i = [...u[n - 1][s - 1], n - 1],
                                g = s - 1 + t.length;
                            (!u[n][g] || i.length > u[n][g].length) && (u[n][g] = i)
                        }
                    }
            }
            return null
    ...
    const an = n => z(n).map((n => {
            const i = G().get(n) || l.get(n) || n;
            return {
                origin: n,
                result: i,
                isZh: i !== n,
        ...
        kn = n => n.map((n => n.isZh ? n.result.split(" ").map((i => ({
            origin: n.origin,
            result: i,
            isZh: !0,
            originPinyin: i
        }))) : [n])),
        vn = (n, i) => "array" === i.type ? Array.from(new Set(n.map((n => n.result)))) : "all" === i.type ? n.map((n => {
            const i = n.isZh ? n.result : "",
                {
                    initial: g,
                    final: h
                } = Y(i),
        ...
        })) : Array.from(new Set(n.map((n => n.result)))).join(" "),
        Sn = {
            separator: " ",
            format: "numToSymbol"
        },
    ...
    var On;
    n.OutputFormat = void 0, (On = n.OutputFormat || (n.OutputFormat = {}))[On.AllSegment = 1] = "AllSegment", On[On.AllArray = 2] = "AllArray", On[On.AllString = 3] = "AllString", On[On.PinyinSegment = 4] = "PinyinSegment", On[On.PinyinArray = 5] = "PinyinArray", On[On.PinyinString = 6] = "PinyinString", On[On.ZhSegment = 7] = "ZhSegment", On[On.ZhArray = 8] = "ZhArray", On[On.ZhString = 9] = "ZhString";
    const Pn = {
        toneType: "symbol",
        mode: "normal",
        nonZh: "spaced",
        ...
        toneSandhi: !0,
        segmentit: 2,
        format: n.OutputFormat.AllSegment
    };
    n.addDict = function(n, i) {
        const g = [],
            h = ("object" == typeof i ? i.name : i) || en,
            u = (null == i ? void 0 : i.dict1) || "add";
        for (let i in n) {
            const z = n[i],
                t = Array.isArray(z) ? z[0] : z,
                y = o(i);
            1 === y && bn(h, i, t, u), Array.isArray(z) ? g.push({
                zh: i,
                pinyin: t,
                probability: "number" == typeof z[1] ? z[1] : 2e-8 * y * y,
                length: y,
                priority: s.Normal,
                dict: h,
                pos: "string" == typeof z[2] ? z[2] : ""
            }) : g.push({
                zh: i,
                pinyin: t,
                probability: 2e-8 * y * y,
                length: y,
                priority: s.Normal,
                dict: h
            })
        ...
        W.build(g)
    }, n.clearCustomDict = function(n) {
        "pinyin" !== n && -1 === n.indexOf("pinyin") || (Object.keys(H).forEach((function(n) {
            delete H[n]
        })), W.removeDict(U)), "multiple" !== n && -1 === n.indexOf("multiple") || L.clear(), "polyphonic" !== n && -1 === n.indexOf("polyphonic") || Q.clear()
    }, n.convert = function(n, i) {
        i = Object.assign(Object.assign({}, Sn), i || {});
        const g = typeof n;
        return "string" == typeof n && (n = n.split(i.separator)), n = n.map((n => {
            const g = i.format;
            return "numToSymbol" === g ? function(n) {
                const i = Number(n[n.length - 1]);
                if (i >= 0 && i <= 4) {
                    for (let g in Zn)
                        if (n.includes(g)) return n.slice(0, n.length - 1).replace(g, Zn[g][i]);
                    return n
                }
                return n
            }(n) : "symbolToNum" === g ? function(n) {
                return `${V(n)}${gn(n)}`
            }(n) : "toneNone" === g ? function(n) {
                return V(n)
            }(n) : n
        })), "string" === g ? n.join(i.separator) : n
    }, n.customPinyin = function(n = {}, i) {
        Object.keys(n).sort(((n, i) => o(i) - o(n))).forEach((i => {
            H[i] = n[i]
        }));
        const g = Object.keys(H).map((n => ({
            zh: n,
            pinyin: H[n],
            probability: 1 + o(n),
            length: o(n),
        ...
        W.build(g), (null == i ? void 0 : i.multiple) && _(n, L, i.multiple), (null == i ? void 0 : i.polyphonic) && _(n, Q, i.polyphonic)
    }, n.getFinalParts = nn, n.getInitialAndFinal = Y, n.getNumOfTone = gn, n.html = (n, i) => {
        const g = Object.assign(Object.assign({}, fn), i || {});
        return dn(n, {
            type: "all",
            toneType: g.toneType,
            toneSandhi: null == i ? void 0 : i.toneSandhi
        }).map((n => {
            let i = "";
            for (const h in g.customClassMap) {
                g.customClassMap[h].includes(n.origin) && (i += ` ${h}`)
            }
            if (n.isZh) {
                const h = g.resultClass || fn.resultClass,
                    u = g.chineseClass || fn.chineseClass,
                    s = g.pinyinClass || fn.pinyinClass;
                return `<span class="${h}${i}"><ruby><span class="${u}">${n.origin}</span>${g.rp?"<rp>(</rp>":""}<rt class="${s}">${n.pinyin}</rt>${g.rp?"<rp>)</rp>":""}</ruby></span>`
            }
            if (g.wrapNonChinese) {
                return `<span class="${g.nonChineseClass||fn.nonChineseClass}${i}">${n.origin}</span>`
            }
            return n.origin
        })).join("")
    }, n.match = (n, i, g) => {
        "any" === (null == g ? void 0 : g.precision) && (g.lastPrecision = "any"), (null == g ? void 0 : g.v) && (i = i.replace(/ü/g, "v"));
        const h = Object.assign(Object.assign({}, xn), g || {});
        !1 !== h.insensitive && (n = n.toLowerCase(), i = i.toLowerCase()), "ignore" === h.space && (i = i.replace(/\s/g, ""));
        return function(n, i) {
            if (!i) return null;
            const g = [];
            let h = 0;
            ...
            for (let n = 0; n < i.length; n++) {
                const o = i[n];
                for (; s <= o;) 2 === u[s].length && h++, s++;
                const z = o + h;
                2 === u[o].length ? g.push(z - 1, z) : g.push(z)
            }
            return g
        }(n, "any" === (null == g ? void 0 : g.precision) ? pn(n, i, h) : wn(n, i, h))
    }, n.pinyin = dn, n.polyphonic = function(n, i = qn) {
        if (!un(n)) return [];
        if ("" === n) return [];
        "all" === i.type && (i.pattern = "pinyin"), "num" === i.pattern && (i.toneType = "none");
        let g = an(n);
        g = on(g, i);
        let h = kn(g);
        h.forEach((n => {
        ...
        return h.map((n => vn(n, i)))
    }, n.removeDict = function(n) {
        W.removeDict(n || en),
            function(n) {
                const i = rn.get(n) || {};
                for (let n in i) l.set(n, i[n]), delete i[n]
            }(n || en)
    }, n.segment = function(i, g) {
        if (g = Object.assign(Object.assign({}, Pn), g || {}), !un(i)) return i;
        void 0 === g.surname && ("surname" === g.mode ? g.surname = "all" : g.surname = "off");
        let h = Array(o(i)),
            {
                list: u,
                matches: s
            } = K(i, h, g.surname, g.segmentit);
        u = cn(u, g.toneSandhi), u = on(u, g), yn(u, g), ln(u, g);
        const t = function(n, i) {
            const g = [];
            let h = 0,
                u = 0;
            for (; h < n.length && u < i.length;) {
                const s = i[u],
                    o = n[h];
                if (s.zh.startsWith(o.origin)) {
                    const i = h,
                        o = z(s.zh);
                    let t = i + 1;
                    for (; t < n.length && n[t].origin === o[t - i];) t++;
                    const y = n.slice(i, t);
                    g.push({
                        segment: y.map((n => ({
                            origin: n.origin,
        ...
        return function(i, g) {
            const {
                format: h = n.OutputFormat.AllSegment,
                separator: u = " "
            } = g;
            if (h === n.OutputFormat.AllSegment) return i.map((n => ({
                origin: n.segment.map((n => n.origin)).join(""),
                result: n.segment.map((n => n.result)).join("")
            })));
            if (h === n.OutputFormat.AllArray) return i.map((n => n.segment));
            if (h === n.OutputFormat.AllString) {
                const n = i.map((n => ({
                    origin: n.segment.map((n => n.origin)).join(""),
                    result: n.segment.map((n => n.result)).join("")
                })));
                return {
                    origin: n.map((n => n.origin)).join(u),
                    result: n.map((n => n.result)).join(u)
                }
            }
            return h === n.OutputFormat.PinyinSegment ? i.map((n => n.segment.map((n => n.result)).join(""))) : h === n.OutputFormat.PinyinArray ? i.map((n => n.segment.map((n => n.result)))) : h === n.OutputFormat.PinyinString ? i.map((n => n.segment.map((n => n.result)).join(""))).join(u) : h === n.OutputFormat.ZhSegment ? i.map((n => n.segment.map((n => n.origin)).join(""))) : h === n.OutputFormat.ZhArray ? i.map((n => n.segment.map((n => n.origin)))) : h === n.OutputFormat.ZhString ? i.map((n => n.segment.map((n => n.origin)).join(""))).join(u) : void 0
        }(t, {
            format: g.format,
