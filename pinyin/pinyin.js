!(function (n, i) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(['exports'], i)
      : i(((n = 'undefined' != typeof globalThis ? globalThis : n || self).pinyinPro = {}));
})(this, function (n) {
  'use strict';
  const i = /^[\uD800-\uDBFF]$/,
    g = /^[\uDC00-\uDFFF]$/,
  ...
  var u;
  !(function (n) {
    ((n[(n.Unknown = 1e-13)] = 'Unknown'),
      (n[(n.Rule = 1e-12)] = 'Rule'),
      (n[(n.DICT = 2e-8)] = 'DICT'),
      (n[(n.Surname = 1)] = 'Surname'),
      (n[(n.Custom = 1)] = 'Custom'));
  })(u || (u = {}));
  const s = {
    Normal: 1,
  ...
  function z(n) {
    ...
    for (; u < n.length; ) {
      const s = n[u];
      i.test(s) && g.test(n[u + 1])
        ? (h.push(n.substring(u, u + 2)), (u += 2))
        : (h.push(s), (u += 1));
    }
    return h;
  }
      ...
      (function (n, i, g) {
        ...
        if (g && !f[n].includes(g)) {
          ...
          if (i !== g) {
            const g = gn(i),
              h = w[n];
            for (let n in h) if (-1 !== h[n].indexOf(Number(g))) return n;
          }
        }
      })(n, i, g) ||
      J(n)
  ...
  function $(n, i) {
    return n &&
      (n.decimal < i.decimal || (n.decimal === i.decimal && n.probability > i.probability))
      ? n
      : i;
  }
  ...
  function E(n) {
    return n.priority === s.Custom
      ? -n.length * n.length * 100
      : n.priority === s.Surname
        ? -n.length * n.length * 10
        : 0;
  }
  ...
  var I;
  !(function (n) {
    ((n[(n.ReverseMaxMatch = 1)] = 'ReverseMaxMatch'),
      (n[(n.MaxProbability = 2)] = 'MaxProbability'),
      (n[(n.MinTokenization = 3)] = 'MinTokenization'));
  })(I || (I = {}));
  class R {
    constructor(n, i = '', g = '') {
  ...
  const B = [...F, ...T, ...P, ...Z, ...p, ...v],
    W = new (class {
      ...
      addPatternToDictMap(n) {
        (this.dictMap.has(n.dict) || this.dictMap.set(n.dict, new Set()),
          this.dictMap.get(n.dict).add(n));
      }
      addNodeToQueues(n) {
        (this.queues[o(n.prefix)] || (this.queues[o(n.prefix)] = []),
          this.queues[o(n.prefix)].push(n));
      }
      insertPattern(n, i) {
      ...
      match(n, i) {
        ...
        for (let n = 0; n < u.length; n++) {
          ...
          if (null === g) g = this.root;
            ...
            g = g.children.get(o);
            const u = g.patterns.find((g) =>
              'off' === i ? g.priority !== s.Surname : 'head' !== i || g.length - 1 - n == 0
            );
            u &&
              h.push(
          ...
          ? (function (n) {
              ...
              for (let u = n.length - 1; u >= 0; ) {
                ...
                for (
                  ...
                  ((g = n[u]),
                  !(
                    (h = n[o]).index + h.length <= g.index ||
                    h.priority > g.priority ||
                    (h.priority === g.priority && h.length > g.length)
                  ));
                )
                  o--;
          ...
          : 3 === g
            ? (function (n, i) {
                ...
                for (let s = i - 1; s >= 0; s--) {
                  ...
                  ((g[s] = N(g[s], z)),
                    g[s].concatPattern &&
                      ((g[s].patterns = g[s].patterns.concat(g[s].concatPattern)),
                      (g[s].concatPattern = void 0),
                      delete g[s + 1]));
                }
  ...
  function _(n, i, g) {
    for (let h in n) {
      ...
      z(h).forEach((n, h) => {
        const s = u.split(' ')[h] || '';
        'replace' === g || ('add' === g && !i.get(n) && !l.get(n))
          ? i.set(n, s)
          : (i.set(n, i.get(n) || l.get(n)),
            i.get(n).split(' ').includes(s) || i.set(n, `${i.get(n)} ${s}`.trim()));
      });
    }
  }
  const G = () => Q;
  const J = (n) => {
    ...
    Y = (n) => {
      ...
      for (let n of i)
        for (let i of c)
          if (n.startsWith(i)) {
            let u = n.slice(i.length);
            (-1 !== j.indexOf(i) && -1 !== d.indexOf(u) && (u = e[u]), g.push(i), h.push(u));
            break;
          }
      return {
        final: h.join(' '),
    ...
    un = (n) =>
      'string' == typeof n ||
      (console.error(
        'The first param of pinyin is error: ' + n + ' is not assignable to type "string".'
      ),
      !1);
  ...
  const on = (n, i) => {
      ...
      if ('consecutive' === g) {
        for (let g = n.length - 2; g >= 0; g--) {
          ...
          !h.isZh &&
            !u.isZh &&
            sn(h.origin, i.nonZhScope) &&
            sn(u.origin, i.nonZhScope) &&
            ((h.origin += u.origin), (h.result += u.result), (u.delete = !0));
        }
    ...
    cn = (n, i) => (
      !1 === i &&
        n.forEach((n) => {
          '一' === n.origin
            ? (n.result = n.originPinyin = 'yī')
            : '不' === n.origin && (n.result = n.originPinyin = 'bù');
        }),
      n
    ),
    jn = {
  ...
  function dn(n, i) {
    ...
    (void 0 === i.surname && ('surname' === i.mode ? (i.surname = 'all') : (i.surname = 'off')),
      'all' === i.type && (i.pattern = 'pinyin'),
      'num' === i.pattern && (i.toneType = 'none'),
      i.removeNonZh && (i.nonZh = 'removed'));
    let g = Array(o(n)),
      { list: h } = K(n, g, i.surname, i.segmentit);
    return (
      (h = cn(h, i.toneSandhi)),
      (h = on(h, i)),
      zn(n, i) && (h = zn(n, i)),
          ...
          : 'all' === i.type
            ? n.map((n) => {
                const g = n.isZh ? n.result : '',
                  { initial: h, final: u } = Y(g),
                  { head: s, body: o, tail: z } = nn(g);
                let t = [];
                return (
                  '' !== g && (t = [g].concat(X(n.origin, i.surname).filter((n) => n !== g))),
                  {
                    origin: n.origin,
                    pinyin: g,
                    initial: h,
        ...
        for (let s = 1; s <= i.length; s++)
          if (u[n - 1][s - 1] && (1 === s || u[n - 1][s - 1].length)) {
            ...
            if (h[n - 1] === i[s - 1]) {
              ...
              if (((!u[n][s] || g.length > u[n][s].length) && (u[n][s] = g), s === i.length))
                return u[n][s];
            }
            if (i.length - s <= 6) {
              if (
                o.some((n) =>
                  'any' === g.lastPrecision
                    ? n.includes(i.slice(s - 1, i.length))
                    : 'start' === g.lastPrecision
                      ? n.startsWith(i.slice(s - 1, i.length))
                      : 'first' === g.lastPrecision
                        ? n[0] === i.slice(s - 1, i.length)
                        : 'every' === g.lastPrecision && n === i.slice(s - 1, i.length)
                )
              )
                return [...u[n - 1][s - 1], n - 1];
            }
            const z = g.precision;
            if (
              ('start' === z &&
                o.forEach((g) => {
                  ...
                  for (; h <= i.length && g.startsWith(i.slice(s - 1, h)); )
                    ((!u[n][h] || o.length > u[n][h].length) && (u[n][h] = o), h++);
                }),
  ...
  const an = (n) =>
    ...
    vn = (n, i) =>
      'array' === i.type
        ? Array.from(new Set(n.map((n) => n.result)))
        : 'all' === i.type
          ? n.map((n) => {
              const i = n.isZh ? n.result : '',
                { initial: g, final: h } = Y(i),
                { head: u, body: s, tail: o } = nn(i);
              return {
                origin: n.origin,
                pinyin: i,
                initial: g,
  ...
  var On;
  ((n.OutputFormat = void 0),
    ((On = n.OutputFormat || (n.OutputFormat = {}))[(On.AllSegment = 1)] = 'AllSegment'),
    (On[(On.AllArray = 2)] = 'AllArray'),
    (On[(On.AllString = 3)] = 'AllString'),
    (On[(On.PinyinSegment = 4)] = 'PinyinSegment'),
    (On[(On.PinyinArray = 5)] = 'PinyinArray'),
    (On[(On.PinyinString = 6)] = 'PinyinString'),
    (On[(On.ZhSegment = 7)] = 'ZhSegment'),
    (On[(On.ZhArray = 8)] = 'ZhArray'),
    (On[(On.ZhString = 9)] = 'ZhString'));
  const Pn = {
    toneType: 'symbol',
    mode: 'normal',
    nonZh: 'spaced',
  ...
  ((n.addDict = function (n, i) {
    ...
    (n.clearCustomDict = function (n) {
      (('pinyin' !== n && -1 === n.indexOf('pinyin')) ||
        (Object.keys(H).forEach(function (n) {
          delete H[n];
        }),
        W.removeDict(U)),
        ('multiple' !== n && -1 === n.indexOf('multiple')) || L.clear(),
        ('polyphonic' !== n && -1 === n.indexOf('polyphonic')) || Q.clear());
    }),
    (n.convert = function (n, i) {
      i = Object.assign(Object.assign({}, Sn), i || {});
      const g = typeof n;
      return (
        'string' == typeof n && (n = n.split(i.separator)),
        (n = n.map((n) => {
          const g = i.format;
          return 'numToSymbol' === g
            ? (function (n) {
    ...
    (n.customPinyin = function (n = {}, i) {
      ...
      (W.build(g),
        (null == i ? void 0 : i.multiple) && _(n, L, i.multiple),
        (null == i ? void 0 : i.polyphonic) && _(n, Q, i.polyphonic));
    }),
    (n.getFinalParts = nn),
    (n.getInitialAndFinal = Y),
    (n.getNumOfTone = gn),
    (n.html = (n, i) => {
    ...
    (n.match = (n, i, g) => {
      ('any' === (null == g ? void 0 : g.precision) && (g.lastPrecision = 'any'),
        (null == g ? void 0 : g.v) && (i = i.replace(/ü/g, 'v')));
      const h = Object.assign(Object.assign({}, xn), g || {});
      (!1 !== h.insensitive && ((n = n.toLowerCase()), (i = i.toLowerCase())),
        'ignore' === h.space && (i = i.replace(/\s/g, '')));
      return (function (n, i) {
        if (!i) return null;
        const g = [];
        let h = 0;
    ...
    (n.segment = function (i, g) {
      ...
      let h = Array(o(i)),
        { list: u, matches: s } = K(i, h, g.surname, g.segmentit);
      ...
      return (function (i, g) {
        const { format: h = n.OutputFormat.AllSegment, separator: u = ' ' } = g;
        if (h === n.OutputFormat.AllSegment)
          return i.map((n) => ({
        ...
        return h === n.OutputFormat.PinyinSegment
          ? i.map((n) => n.segment.map((n) => n.result).join(''))
          : h === n.OutputFormat.PinyinArray
            ? i.map((n) => n.segment.map((n) => n.result))
            : h === n.OutputFormat.PinyinString
              ? i.map((n) => n.segment.map((n) => n.result).join('')).join(u)
              : h === n.OutputFormat.ZhSegment
                ? i.map((n) => n.segment.map((n) => n.origin).join(''))
                : h === n.OutputFormat.ZhArray
                  ? i.map((n) => n.segment.map((n) => n.origin))
                  : h === n.OutputFormat.ZhString
                    ? i.map((n) => n.segment.map((n) => n.origin).join('')).join(u)
                    : void 0;
      })(t, {
        format: g.format,
