...
<div id="inputForm">
    ...
    <div style="text-align: center;">
        ...
        <button id="hibernate"><img id="hiberate-gif" src="hibernate.gif" style="width: 75px; height: 75px;" /><span class="eng">Hibernate</span><span class="chn">冬眠</span></button> &nbsp; &nbsp;
        <button id="christmas"><img id="christmas-gif" src="christmas.gif" style="width: 75px; height: 75px;" /><span class="eng">Christmas</span><span class="chn">圣诞</span></button> &nbsp; &nbsp;
        <button id="thanksgiving"><img id="thanksgiving-gif" src="thanksgiving.gif" style="width: 75px; height: 75px;" /><span class="eng">Thanksgiving</span><span class="chn">感恩</span></button> &nbsp; &nbsp;
    </div>
</div>
<div id="controls">
